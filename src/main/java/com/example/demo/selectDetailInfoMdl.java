...
public class selectDetailInfoMdl {
	...
	public void selectDetailInfo(List detailInfo, String syainId) {
		...
		List selectResult = jdbcTemplate.queryForList(
				"SELECT a.syainId,a.syainName,a.affiliation,a.baseSalary,b.position,b.position_Allowance,c.address,c.residentTax,d.familyStructure,d.family_Allowance, FLOOR(DATEDIFF(CURDATE(), e.hire_date) / 365) as serviceLength FROM "
